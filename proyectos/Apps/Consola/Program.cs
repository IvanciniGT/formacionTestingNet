...
Console.WriteLine("🔍 ¡Bienvenido al Diccionario App! 📚");
Console.WriteLine("════════════════════════════════════");
...
if (args.Length != 2)
{
    ...
    Console.WriteLine("   Uso: DiccionariosAppConsola <idioma> <palabra>");
    Console.WriteLine("   Ejemplo: DiccionariosAppConsola ES melón");
    MostrarDespedida();
    return;
}
...
// Crear el suministrador de diccionarios (hardcodeado)
var rutaDiccionarios = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Diccionarios");
var suministrador = new ProveedorDiccionariosFicheros(rutaDiccionarios);
...
Console.WriteLine($"🎉 ¡Encontré la palabra '{palabra}'! Aquí están sus significados:");
Console.WriteLine();
...
static void MostrarDespedida()
{
    Console.WriteLine();
    Console.WriteLine("════════════════════════════════════");
    Console.WriteLine("🙏 ¡Gracias por usar Diccionario App!");
